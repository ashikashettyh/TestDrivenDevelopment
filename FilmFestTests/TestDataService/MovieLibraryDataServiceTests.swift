...
class MovieLibraryDataServiceTests: XCTestCase {
    ...
    func testTableViewSections_CountReturnsTwo() {
    ...
    func testTableViewSectionsRows_sectionOne_ReturnsMoviesToSeeCount() {
...
//        XCTAssertEqual(libraryTableView.numberOfRows(inSection: 1), 2)
    ...
    func testCell_SelectionShouldCheckOffSelectedMovie() {
        sut.movieManager?.addMovie(movie: fairyTale)
        sut.movieManager?.addMovie(movie: darkComedy)
    ...
    func testTableViewSectionTitles_ShouldHaveRightStringValues() {
